...
exports.ColumnEmail = ColumnEmail;
var common_1 = require("@nestjs/common");
var typeorm_1 = require("typeorm");
var field_lengths_constant_js_1 = require("../../constants/field-lengths.constant.js");
function ColumnEmail(options) {
    var _a, _b;
    var length = (_a = options === null || options === void 0 ? void 0 : options.maxLength) !== null && _a !== void 0 ? _a : field_lengths_constant_js_1.EMAIL_MAX_LENGTH;
